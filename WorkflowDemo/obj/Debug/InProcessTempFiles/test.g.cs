...
public partial class Test : System.Activities.Activity<int>, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
    ...
    public void InitializeComponent() {
        ...
        System.IO.Stream initializeXaml = typeof(Test).Assembly.GetManifestResourceStream(resourceName);
        ...
        try {
            ...
            writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Test));
    ...
    private string FindResource() {
        string[] resources = typeof(Test).Assembly.GetManifestResourceNames();
        for (int i = 0; (i < resources.Length); i = (i + 1)) {
            string resource = resources[i];
            if ((resource.Contains(".test.g.xaml") || resource.Equals("test.g.xaml"))) {
                return resource;
            }
        }
